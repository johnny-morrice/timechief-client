...
type Theme struct {
	ActionButtonFontSize               string   `json:"action_button_font_size"`
	...
	AstroFontSize                      string   `json:"astro_font_size"`
	...
	CalendarDayDateFontSize            string   `json:"calendar_day_date_font_size"`
	CalendarDayFontSize                string   `json:"calendar_day_font_size"`
	CurrentWeatherFontSize             string   `json:"current_weather_font_size"`
	CurrentWeatherIconFontSize         string   `json:"current_weather_icon_font_size"`
	DateFontSize                       string   `json:"date_font_size"`
	...
	TimeFontSize                       string   `json:"time_font_size"`
	Uuid                               string   `json:"uuid"`
	WeatherDataFontSize                string   `json:"weather_data_font_size"`
...
// ListLatestVersionsParams defines parameters for ListLatestVersions.
type ListLatestVersionsParams struct {
	// IncludeNonLiveVersions Include non-live versions
	IncludeNonLiveVersions *bool `form:"include_non_live_versions,omitempty" json:"include_non_live_versions,omitempty"`
}
...
type ClientInterface interface {
	...
	ListLatestVersions(ctx context.Context, product string, stream string, params *ListLatestVersionsParams, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) ListLatestVersions(ctx context.Context, product string, stream string, params *ListLatestVersionsParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewListLatestVersionsRequest(c.Server, product, stream, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewListLatestVersionsRequest(server string, product string, stream string, params *ListLatestVersionsParams) (*http.Request, error) {
	var err error
	...
	if params != nil {
		...
		if params.IncludeNonLiveVersions != nil {

			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "include_non_live_versions", runtime.ParamLocationQuery, *params.IncludeNonLiveVersions); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
type ClientWithResponsesInterface interface {
	...
	ListLatestVersionsWithResponse(ctx context.Context, product string, stream string, params *ListLatestVersionsParams, reqEditors ...RequestEditorFn) (*ListLatestVersionsResponse, error)
...
func (c *ClientWithResponses) ListLatestVersionsWithResponse(ctx context.Context, product string, stream string, params *ListLatestVersionsParams, reqEditors ...RequestEditorFn) (*ListLatestVersionsResponse, error) {
	rsp, err := c.ListLatestVersions(ctx, product, stream, params, reqEditors...)
	if err != nil {
		return nil, err
	}
