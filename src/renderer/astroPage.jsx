...
class AstroPageSignals {
  constructor() {
      ...
      [this.moonphase, this.setMoonphase] = createSignal("");
...
export const AstroPage = () => {
  let configSignals = new AstroPageSignals();
  let taskBarSignals = getTaskBarSignals();

  addClockDataCallback((data) => updateAstroPageSignals(configSignals, data));
